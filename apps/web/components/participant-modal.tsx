    ...
    >
      <div className="relative w-full max-w-md rounded-2xl bg-gradient-to-b from-[#101617] to-[#0a1415] p-6 shadow-xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="mb-2 text-2xl font-light text-white">Tournament Participant</h3>
          <p className="mb-6 text-[#B3EFF5]/80">
            Join tournaments and compete for prizes with automatic payouts on the blockchain.
          </p>
          ...
          {wallet ? (
            <div className="w-full space-y-4">
              <div className="rounded-lg bg-[#0a1415]/80 border border-[#345D61] p-4 text-left">
                <div className="flex items-center gap-3 mb-2">
                  <Medal size={20} className="text-[#B3EFF5]" />
                  <h4 className="text-white font-medium">Your Tournaments</h4>
                </div>
                <p className="text-sm text-gray-300">
                  You're not currently registered for any tournaments. Find events to join now.
                </p>
              </div>
            ...
            <div className="w-full space-y-4">
              <div className="flex flex-col items-center justify-center py-6">
                ...
                <p className="text-[#B3EFF5]/80 mb-4">Your participant account has been successfully created.</p>
                <Link
                  href="/participant/dashboard"
                  className="block w-full px-6 py-3 rounded-lg bg-gradient-to-r from-[#191D1E] via-[#345D61] to-[#191D1E] border border-white/30 text-white hover:bg-opacity-90 transition-all hover:scale-105 text-center"
                  onClick={onClose}
            ...
            <div className="w-full space-y-4">
              <p className="text-sm text-gray-300 mb-4">
                Sign up or log in to start joining tournaments and competing on Strikechain.
              </p>
          ...
          <div className="mt-6 flex flex-col gap-3 w-full">
            <div className="flex items-center gap-2 text-sm text-[#B3EFF5]/70">
              <Search size={16} />
              <span>Find and join tournaments in your favorite sports</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-[#B3EFF5]/70">
              <Wallet size={16} />
              <span>Receive winnings automatically in your wallet</span>
            </div>
          </div>
        </div>
      </div>
