  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <section className="relative">
        ...
        <header className="absolute top-0 left-0 right-0 z-10 backdrop-blur-[2px]">
          <div className="container mx-auto px-4 py-6 border-b border-white/10">
            <div className="flex items-center justify-between">
              <Link href="/" className="flex items-center gap-1">
                <Image
                  src="/strikechain-logo.png"
                  alt="Strikechain Logo"
                  width={44}
                  height={44}
                  className="w-11 h-11"
                />
                <span className="text-2xl font-bold text-white">Strikechain</span>
              </Link>
              <nav className="flex items-center gap-8">
                ...
                <Link href="/benefits" className="text-sm text-white hover:text-gray-300">
                  Benefits
                </Link>
